...
__all__ = ['DATA_DIR_COVID', 'asegura_archivos_covid_disponibles', 'columnas_comunes', 'arregla_cvegeo',
           'carga_datos_covid19_MX', 'DATA_DIR_COVID', 'procesa_fechas', 'daterange', 'actualizar_datos_salud',
           'agrupa_casos_municipios', 'leer_variables_municipales', 'unir_casos_estadisticas_municipales',
           'tabla_covid_indicadores_municipales', 'municipios_urbanos']
...
def carga_datos_covid19_MX(fecha='200601', resolver_claves='si_no_binarias',
                           periodo='dia', fecha_formato='0412', nuevo_formato=False):
    """
        ...
        **Nota 2**: El catálogo Resultado_LAB del formato de datos 07-10-2020 tiene el primer rengló vacío, y el catálogo CLASIFICACION
...
def actualizar_datos_salud(directorio_datos='./datos/secretaria_salud/', fecha_inicio='12-04-2020'):
    ...
    for fecha in daterange(fecha_inicio.date(), hoy):
